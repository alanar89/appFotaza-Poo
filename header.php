<nav class="navbar navbar-expand-lg navbar-dark bg-primary text-uppercase">
    ...
    if(isset($_SESSION['usuario'])){?>
      <div class="mb-2 col-md-6">
                <form method="POST" id="formbuscar" name="formbuscar" action="" enctype="">
    ...
    <li class="nav-item">
                    <a class="nav-link mt-2 me-2 text-light" href="publicaciones.php">Publicaciones</a>
                </li>
        <li class="nav-item dropdown d-none d-md-block">
        <a class="nav-link dropdown-toggle" href="#" id="menuPerfil" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo'img/'.$_SESSION['foto']?>" alt="" width="40" height="40" class="foto">
        ...
        <li class="nav-item d-md-none">
                    <a class="nav-link mt-2 text-light" href="perfil.php">Perfil</a>
                </li>
                <li class="nav-item d-md-none">
                <a class="nav-link mt-2 text-light" href="cerrarSesion.php">Salir</a>
                </li>
      </ul>
        ...
        <ul class="navbar-nav mb-2 mb-lg-0 me-5">
            <li class="nav-item">
                <a class="nav-link text-light ms-md-5 me-2" href="login.php" tabindex="-1" aria-disabled="false">Ingresar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="registro.php" tabindex="-1" aria-disabled="false">Registrarse</a>
            </li>
        </ul>
    </div>
    <?php }?>
