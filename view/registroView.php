            ...
            <div class="row">
                ...
                <div class="col-md-6  p-5">
                    <div class="text-primary text-center mt-3 mb-4 fs-5">
                        <a class="text-decoration-none" href="<?php echo $helper->url("Inicio", "index"); ?>"> <i class="fas fa-camera-retro lista"></i> Fotaza</a>
                    </div>
                    <h2 class=" text-center  display-6 mb-3">Registro</h2>
                    <form method="POST" name="formRegistro" action="<?php echo $helper->url("Usuario", "crear"); ?>" enctype="multipart/form-data">
                        <div class="mb-3 ">
                        ...
                        <?php if (isset($_GET['res'])) {
                            echo "<div class='alert alert-danger p-1' role='alert' id='apwe'> El Email ya existe </div>";
                        } ?>
                        <button type="button" class="btn btn-primary col-12" onclick="validar()">registrarse</button>
                    </form>
                    <div class="mt-4 mb-4">Ya tienes cuenta? <a href="<?php echo $helper->url("Usuario", "login"); ?>" class="">Ingresar</a></div>
                </div>
            </div>
        </div>
        <footer>
